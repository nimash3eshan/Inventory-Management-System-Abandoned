        ...
        <form method="post" action="{{ route('environmentSaveWizard') }}" class="tabs-wrap">
            ...
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value="FlexiblePos" placeholder="{{ trans('installer_messages.environment.wizard.form.app_name_placeholder') }}" />
            ...
            <div class="tab" id="tab2content">
                ...
                <input type="text" name="user_name" id="user_name" value="" placeholder="{{ __('Your Username') }}" />
